# -*- coding: utf-8 -*-
"""Siamese_ResNet101_valc.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jS8cuc_fC0lInJprIIh4tY6Rv_RM8PRm
"""
...
def contrastive_accuracy(y_true, pred_dist):
  accuracy = K.mean(K.equal(y_true, K.cast(pred_dist < 10, y_true.dtype)))
  return accuracy
...
siamese_model.save_weights("./model_weights/siamese_weights_101_valc.h5")
print("Weights saved!")

with open('batch_history_101_valc.pkl', 'wb') as f:
